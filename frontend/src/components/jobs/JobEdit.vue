<template>
  <v-row justify="center">
    <v-dialog v-model="editJobDialog" persistent max-width="750px">
      <v-stepper v-model="step" elevation="0" class="secondary">
        ...
        <v-stepper-items>
          <v-form ref="editJobForm" lazy-validation>
            <v-stepper-content step="1">
              ...
              <v-col class="text-right">
                <v-btn text class="text-capitalize" @click="closeEditJobDialog">
                  Cancel
                </v-btn>
            ...
            <v-stepper-content step="3">
              ...
              <v-col class="text-right">
                ...
                <v-btn
                  ...
                  :loading="editJobBtnLoader"
                  :disabled="editJobBtnLoader"
                  @click="editJob"
                >
                  Submit
                </v-btn>
...
export default {
  ...
  methods: {
    ...
    closeEditJobDialog() {
      this.$emit("jobEditClose");
    },

    editJob() {
      if (this.$refs.editJobForm.validate()) {
        this.editJobBtnLoader = true;
        ...
        this.$http
          ...
          .then((result) => {
            if (result.status === 200) {
              ...
              this.$emit("jobEditEvent");
            }
          })
          .finally(() => {
            this.editJobBtnLoader = false;
          });
      }
    },
